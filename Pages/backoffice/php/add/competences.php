...
<form action="Pages/backoffice/php/add/validator/validateCompetences.php" method="POST" class="form-add">
    <div class="form-group">
        <label for="nom">Nom de la Compétence <span class="span-indication">Pas de caractères spéciaux ni d'espace</span></label>
