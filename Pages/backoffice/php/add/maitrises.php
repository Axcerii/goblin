...
?>
<h2>Ajouter une maîtrise</h2>
<form action="Pages/backoffice/php/add/validator/validateMaitrises.php" method="POST" class="form-add">
    <div class="form-group">
        <label for="nom">Nom de la maîtrise <span class="span-indication">Pas de caractères spéciaux ni d'espace</span></label>
