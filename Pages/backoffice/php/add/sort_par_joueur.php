...
<?php
    ...
    $sorts = $db->executeSQL('SELECT nom FROM sorts ORDER BY nom');
?>
<h2>Ajouter un sort à un joueur</h2>
<form action="Pages/backoffice/php/add/validator/validateSortParJoueur.php" method="POST" class="form-add">
    ...
    <div class="form-group">
        <label for="sort">Nom du sort <span class="span-indication">Références</span></label>
        <div class='div-reference'>
